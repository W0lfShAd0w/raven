...
\vspace{7pt} \\When used as part of a \xmlNode{MultiRun} step, this entity provides
  ...
  \begin{itemize}
    \item \xmlNode{objective}: \xmlDesc{comma-separated strings},
    ...
    \item \xmlNode{samplerInit}:
      ...
      \begin{itemize}
        ...
        \item \xmlNode{type}: \xmlDesc{comma-separated strings},
    ...
    \item \xmlNode{samplerInit}:
      ...
      \begin{itemize}
        ...
        \item \xmlNode{restartFrom}: \xmlDesc{string, optional},
          path to an existing \texttt{.ravenrst} checkpoint file from which the optimizer should
          resume. The optimizer validates that the settings recorded in the checkpoint file are
          compatible with the current XML configuration (variable names, bounds, and cooling
          method) before restoring state. The \xmlNode{SolutionExport}
          DataObject is pre-populated with the historical solution path from the checkpoint so
          that output files appear continuous.
      \end{itemize}
...
\subsection{GeneticAlgorithm}
  The \xmlNode{GeneticAlgorithm} is a metaheuristic optimization technique inspired by the
  ...
  information about NSGA-II can be found in:\\\\                              Deb, Kalyanmoy, et al.
  ...
  \begin{itemize}
    ...
    \item \xmlNode{GAparams}:
      ...
      \begin{itemize}
        ...
        \item \xmlNode{parentSelection}: \xmlDesc{[rouletteWheel, tournamentSelection, rankSelection]},
        ...
        \item \xmlNode{reproduction}:
          ...
          \begin{itemize}
            \item \xmlNode{kSelection}: \xmlDesc{integer},
            ...
            \item \xmlNode{crossover}: \xmlDesc{string},
              ...
              The \xmlNode{crossover} node recognizes the following parameters:
                \begin{itemize}
                  \item \xmlAttr{type}: \xmlDesc{[onePointCrossover, twoPointsCrossover, uniformCrossover], required},
              ...
              \begin{itemize}
                ...
                \item \xmlNode{crossoverProb}: \xmlDesc{float or string},
                  The probability governing the crossover step, i.e., the probability that if
                  exceeded crossover will occur.
                  The \xmlNode{crossoverProb} node recognizes the following parameters:
                    \begin{itemize}
                      \item \xmlAttr{type}: \xmlDesc{[static, adaptive], optional},
            ...
            \item \xmlNode{mutation}: \xmlDesc{string},
              ...
              The \xmlNode{mutation} node recognizes the following parameters:
                \begin{itemize}
                  \item \xmlAttr{type}: \xmlDesc{[swapMutator, scrambleMutator, inversionMutator, randomMutator], required},
              ...
              \begin{itemize}
                ...
                \item \xmlNode{mutationProb}: \xmlDesc{float or string},
                  The probability governing the mutation step, i.e., the probability that if
                  exceeded mutation will occur.
                  The \xmlNode{mutationProb} node recognizes the following parameters:
                    \begin{itemize}
                      \item \xmlAttr{type}: \xmlDesc{[static, adaptive], optional},
        ...
        \item \xmlNode{survivorSelection}: \xmlDesc{[fitnessBased, ageBased, rankNcrowdingBased]},
        ...
        \item \xmlNode{fitness}: \xmlDesc{string},
          ...
          The \xmlNode{fitness} node recognizes the following parameters:
            \begin{itemize}
              \item \xmlAttr{type}: \xmlDesc{[invLinear, feasibleFirst, logistic], required},
          ...
          \begin{itemize}
            \item \xmlNode{a}: \xmlDesc{comma-separated floats},
              a: The weight of objective function(s). \default{list of ones}

            \item \xmlNode{b}: \xmlDesc{comma-separated floats},
              b: The weight of constraint penalty. \default{list of ones}

            \item \xmlNode{scale}: \xmlDesc{comma-separated floats},
              scale: in case of logistic fitness, this is the multiplier of the onjective(s).
              \default{list of ones}

            \item \xmlNode{shift}: \xmlDesc{comma-separated floats},
              shift: in case of logistic fitness, this is the shift in the exponential function for
              the onjective(s). \default{list of zeros}
          \end{itemize}
      \end{itemize}
    ...
    \item \xmlNode{convergence}:
      ...
      The \xmlNode{convergence} node recognizes the following subnodes:
      \begin{itemize}
        \item \xmlNode{objective}: \xmlDesc{comma-separated floats},
