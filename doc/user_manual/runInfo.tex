...
generator (RNG) for the RAVEN calculation. The generator used is the numpy library by default. The initial seed is printed to the RAVEN log
file. A value of \texttt{None} can also be provided to request a high entropy initial seed be automatically generated.
%
\default{None}
